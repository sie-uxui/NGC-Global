...
### What's Changing:
1. **Company Name**: "NGC Marine" → "NGC Global"
2. **Tagline**: Remove "Geared for a Better Future"
3. **Content Balance**: 60% Marine + 40% Industrial (instead of 100% Marine)
4. **Product Categories**: Add industrial gearbox types alongside marine
5. **Images**: 7 images need replacement (same filenames)
...
### **PRODUCTS MEGA MENU - UPDATE COLUMN 2**
...
#### Add These Items to Top of Column 2 List (Before CPP Systems):

```html
<li class="fl-flyout-navigation--item-link">
    <a href="#" title="Submerged Cutter Gearbox">
        <div class="fl-flyout-navigation-icon">
            <img src="assets/icons/dredger/cutter-gearbox.svg" alt="Submerged Cutter">
        </div>
        <div class="fl-flyout-navigation-title">Submerged Cutter Gearbox</div>
    </a>
</li>
<li class="fl-flyout-navigation--item-link">
    <a href="#" title="Dredge Pump Gearbox">
        <div class="fl-flyout-navigation-icon">
            <img src="assets/icons/dredger/pump-gearbox.svg" alt="Dredge Pump">
        </div>
        <div class="fl-flyout-navigation-title">Dredge Pump Gearbox</div>
    </a>
</li>
```

**Keep all existing Marine Propulsion items** under this column (CPP Systems, FPP Gearbox, Azimuth Thruster, etc.)
...
- [ ] Rename Column 2 to "Marine & Dredger Systems"
- [ ] Add top 2 dredger items to Column 2
...
- ✅ Meta descriptions
- ✅ ALT attributes
- ✅ Column 1 HTML structure (replace entire Dredger Gearboxes column with Industrial)

### **What NOT TO Change:**
- ❌ CSS classes or IDs
- ❌ Overall HTML structure/layout
- ❌ JavaScript functionality
- ❌ Bootstrap grid system
- ❌ Any styling attributes
- ❌ Section heights, widths, colors
- ❌ Image filenames (keep the same, just note which need new images)

### **Find & Replace Operations:**
1. `NGC Marine` → `NGC Global` (Global replace)
2. `ngcmarine.com` → `ngcglobal.com` (Email addresses)
3. Check for case variations: `NGC MARINE`, `ngc marine`, etc.
...
### **Key Messaging:**
1. **Versatility:** Industrial + Marine expertise
2. **Experience:** 20 years serving multiple industries
3. **Quality:** Provincial Design Center, complete in-house capabilities
4. **Range:** From cement mills to largest dredgers
5. **Integration:** Complete systems, not just components
...
**Save this file as:** `NGC-Global-Website-Updates.md`
**Save location:** `D:\Skubbs\NGC\NGC-Global\`

**Next Steps:**
1. Save this document to the specified directory
